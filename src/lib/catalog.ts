...
export const CATALOG: CatalogEntry[] = [
  ...
  { key: 'drive_long', emoji: '🚗', points: 30, needsLicense: true, fr: "Conduire plus d'1h", en: 'Drive for more than 1h' },
  ...
  { key: 'drive_short', emoji: '🚙', points: 15, needsLicense: true, fr: "Conduire moins d'1h", en: 'Drive for less than 1h' },
  ...
  { key: 'fuel', emoji: '⛽', points: 10, needsLicense: true, fr: "Faire le plein d'essence", en: 'Fill up the tank' },
