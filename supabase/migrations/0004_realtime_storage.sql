...
-- temps reel : on ne recoit que les changements des groupes dont on est membre.
...
-- (l_etat de l_application). Une photo de 256x256 pese ~20 ko, soit ~27 ko une
...
-- Chaque compte n'ecrit que dans son propre dossier : avatars/<auth.uid()>/...
